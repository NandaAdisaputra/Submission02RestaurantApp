...
class AddReviewFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(AppStrings.addReview, style:TextStyle(color: Colors.white, fontFamily: Constants.helvetica)),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: textFieldController.isButtonEnabled.value
                      ...
                      textFieldController.dateController.clear();
                        ...
                        : null,
                    child: Text(AppStrings.addReview, style: TextStyle(color: Colors.deepOrange, fontFamily: Constants.helvetica),)),
              );
            })
          ],
        ),
